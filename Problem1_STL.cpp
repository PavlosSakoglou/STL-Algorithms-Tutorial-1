...
int main() {
	...
	// Print results
	std::cout << "Increasing:\n";
	std::copy(increasing.begin(), increasing.end(), std::ostream_iterator<char>(std::cout, " "));
	std::cout << "\n\n";

	std::cout << "Decreasing:\n";
	std::copy(decreasing.begin(), decreasing.end(), std::ostream_iterator<char>(std::cout, " "));
	std::cout << "\n\n";
