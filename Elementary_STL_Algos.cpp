...
int main() {
	...
	std::list<double>::iterator found 
		= std::find_if(myList.begin(), myList.end(), is_greater<double>(target));
	...
	std::cout << "List: ";
	std::copy(myList2.begin(), myList2.end(), std::ostream_iterator<double>(std::cout, " "));
	...
	std::cout << "\nNegatives: ";
	std::copy(negatives.begin(),negatives.end(), std::ostream_iterator<double>(std::cout, " "));
	std::cout << "\n\n\n";
